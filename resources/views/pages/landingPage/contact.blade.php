                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" class="px-4 border-0 form-control bg-light" placeholder="Your Name"
                                    style="height: 55px;" name="name" @error('name') is-invalid @enderror
                            ...
                            @enderror
                            <div class="col-md-6">
                                <input type="email" class="px-4 border-0 form-control bg-light"
                                    placeholder="Your Email" style="height: 55px;" name="email"
                                    @error('email') is-invalid @enderror id="email" value="{{ old('email') }}">
                            </div>
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
